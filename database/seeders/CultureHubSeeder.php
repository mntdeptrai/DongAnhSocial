...
class CultureHubSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $establishments = [
            [
                'name'          => 'Nhà văn hóa Xã Đông Anh',
                'slug'          => 'nha-van-hoa-huyen-dong-anh',
                'category_id'   => $cat($cultureHubCategory),
                'commune_id'    => $com('to-dan-pho-so-6'),
                'description'   => 'Trung tâm hoạt động văn hóa nghệ thuật của xã Đông Anh. Nơi tổ chức các sự kiện chính trị, chương trình văn nghệ, triển lãm ảnh và câu lạc bộ nghệ thuật cộng đồng.',
            ...
            [
                ...
                'description'   => 'Không gian trưng bày, giới thiệu sản phẩm làng nghề, sinh vật cảnh, thành tựu phát triển kinh tế xã hội và quảng bá OCOP của xã Đông Anh.',
                'address'       => 'Xã Vân Nội, Xã Đông Anh, Hà Nội',
                'phone'         => '02438839012',
            ...
            [
                ...
                'address'       => 'Thôn Đại Vĩ, Xã Liên Hà, Xã Đông Anh, Hà Nội',
                'phone'         => null,
                'opening_hours' => 'Mở cửa theo lịch sinh hoạt thôn',
                'latitude'      => 21.1530,
                'longitude'     => 105.8910,

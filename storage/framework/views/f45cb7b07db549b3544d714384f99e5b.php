<?php $__env->startSection('title', 'Đăng nhập - Bản đồ số Khám phá Đông Anh'); ?>
        ...
        <div class="glass-panel hover-lift" style="width: 100%; max-width: 440px; padding: 40px; box-shadow: var(--shadow-overlay); border: 1px solid var(--border-glow); background: var(--bg-card); backdrop-filter: blur(20px);">
            ...
            <form action="/auth/login" method="POST">
                ...
                <div class="review-form-group">
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-input" required placeholder="name@example.com" style="padding: 12px 16px; width: 100%;">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/donganhdiscovery.xadonganh.com/FOOD_MAP/resources/views/auth/login.blade.php ENDPATH**/ ?>
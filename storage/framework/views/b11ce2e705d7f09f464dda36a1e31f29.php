    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="instruction" style="text-align: center; font-weight: 600; color: #0284c7;">
                Mã xác thực này có hiệu lực trong vòng <?php echo e($expiryMinutes); ?> phút và chỉ sử dụng được 1 lần duy nhất.
            </div>
        ...
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> Bản đồ khám phá đông anh. All rights reserved.
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\DA_DISCOVERY\resources\views/emails/password-otp.blade.php ENDPATH**/ ?>
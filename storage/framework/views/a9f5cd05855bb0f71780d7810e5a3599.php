<?php $__env->startSection('title', 'Chi tiết đơn hàng #' . str_pad($order->id, 6, '0', STR_PAD_LEFT) . ' - Đông Anh Map'); ?>

<?php $__env->startSection('content'); ?>
<!-- Load premium styling for orders -->
<link rel="stylesheet" href="<?php echo e(asset('css/orders.css')); ?>?v=<?php echo e(time()); ?>">
...
<div class="orders-container">
    ...
    <div class="orders-header-section">
        <h1 class="orders-title">
            📦 Chi tiết đơn hàng #ORD<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?>
    ...
    <div id="order-detail-container" data-order-id="<?php echo e($order->id); ?>">
...
<script src="<?php echo e(asset('js/orders.js')); ?>?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\DA_DISCOVERY\resources\views/checkout/show.blade.php ENDPATH**/ ?>
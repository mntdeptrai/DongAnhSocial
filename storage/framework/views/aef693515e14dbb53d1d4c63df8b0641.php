<?php $__env->startSection('title', 'Đăng ký tài khoản - Bản đồ số Khám phá Đông Anh'); ?>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px 20px; margin-bottom: 24px;">
                    ...
                    <div>
                        <div class="review-form-group" style="margin-bottom: 16px;">
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-input" required placeholder="Nguyễn Văn A" style="padding: 11px 16px; width: 100%;">
                        </div>
                    ...
                    <div>
                        <div class="review-form-group" style="margin-bottom: 16px;">
                            ...
                            <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" class="form-input" required placeholder="Ví dụ: 0901234567" style="padding: 11px 16px; width: 100%;">
                        </div>
                        ...
                        <div class="review-form-group" style="margin-bottom: 16px;">
                            ...
                            <select name="role" class="form-input" style="padding: 11px 16px; width: 100%; height: 42px; cursor: pointer; background: var(--bg-input, rgba(255,255,255,0.05)); border: 1px solid var(--border-glow); border-radius: 8px; color: var(--text-main);">
                                ...
                                <option value="seller" <?php echo e(old('role') === 'seller' ? 'selected' : ''); ?>>Chủ cơ sở, cửa hàng</option>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /www/wwwroot/donganhdiscovery.xadonganh.com/FOOD_MAP/resources/views/auth/register.blade.php ENDPATH**/ ?>
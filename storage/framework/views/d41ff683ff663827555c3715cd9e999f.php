...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Kênh Quản trị - DongAnh Discovery'); ?></title>
    
    <!-- Leaflet.js Map Assets -->
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" integrity="sha256-p4NxAoJBhIIN+hmNHrzRCf9tD/miZyoHS5obTRR9BMY=" crossorigin="" />
    
    <!-- Dedicated Admin Stylesheet -->
    <link rel="stylesheet" href="<?php echo e(asset('css/admin.css')); ?>?v=<?php echo e(file_exists(public_path('css/admin.css')) ? filemtime(public_path('css/admin.css')) : '1.0.0'); ?>">
</head>
<body>
    ...
    <div class="admin-layout-wrapper">
        ...
        <aside class="admin-sidebar-nav">
            ...
            <a href="/admin/eateries/<?php echo e($eatery->slug); ?>/edit" class="admin-menu-item active">
                <span>⚙️</span> <?php echo e(Str::limit($eatery->name, 18, '...')); ?>

            </a>
            <?php elseif($sellerEatery): ?>
            <div class="admin-sidebar-section-title">Quán của tôi</div>
            <a href="/admin/eateries/<?php echo e($sellerEatery->slug); ?>/edit" class="admin-menu-item <?php echo e(request()->is('admin/eateries/' . $sellerEatery->slug . '/edit') ? 'active' : ''); ?>">
                <span>⚙️</span> <?php echo e(Str::limit($sellerEatery->name, 18, '...')); ?>
...
<?php /**PATH /www/wwwroot/donganhdiscovery.xadonganh.com/FOOD_MAP/resources/views/layouts/admin.blade.php ENDPATH**/ ?>
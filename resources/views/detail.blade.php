...
<div class="container" style="padding-top: 20px; margin-bottom: 24px;">
    ...
    <div class="detail-header-wrapper">
        ...
        <div class="detail-header-actions">
            ...
            <button id="btnSaveLoc" onclick="toggleSaveLocation(this, '{{ $eatery->slug }}', '{{ addslashes($eatery->name) }}')" class="btn-secondary" style="border-radius: 30px; padding: 8px 18px; font-size: 0.9rem; border-color: var(--border-glow); display: flex; align-items: center; gap: 6px; background: var(--bg-card); color: var(--text-main); font-weight: 600; cursor: pointer; transition: all 0.2s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='none'">
                <span class="save-icon" style="font-size: 1.1rem;">❤️</span> <span class="save-text">Lưu lại</span>
            </button>
        </div>
        <script>document.addEventListener('DOMContentLoaded', () => initSaveButtonState(document.getElementById('btnSaveLoc'), '{{ $eatery->slug }}'));</script>
    </div>
</div>
    ...
    <div class="detail-grid">
        ...
        <div>
            ...
            @php
                ...
                if (!$mergedList && $categorySlug === 'smart-education-map') {
            ...
            <div class="detail-section glass-panel" style="padding: 28px;">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px; flex-wrap: wrap; gap: 12px;">
                    ...
                    @if($items->count() > 0 && $categorySlug !== 'smart-education-map')
                ...
                @if($categorySlug === 'smart-education-map' && !empty($mergedList) && count($mergedList) > 0)

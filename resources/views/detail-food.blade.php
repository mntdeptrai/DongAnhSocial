...
@section('title', $eatery->name . ' - Địa điểm ăn uống & Nhà hàng quán ngon tại ' . ($eatery->commune?->name ?? 'Đông Anh') . ', Xã Đông Anh')

<!-- Tối ưu hóa SEO: Thẻ mô tả Meta tự sinh chân thực -->
@section('meta_description', 'Khám phá địa điểm ăn uống đặc sắc tại ' . $eatery->name . ' ở ' . $eatery->address . ', ' . ($eatery->commune?->name ?? 'Đông Anh') . ', Xã Đông Anh, Hà Nội. Số điện thoại liên hệ: ' . ($eatery->phone ?: 'Đang cập nhật') . '. Xem đánh giá thực khách và bản đồ chỉ đường.')
...
<style>
    :root {
        --category-accent: #ff7e29;
        --category-accent-dark: #e65100;
        --category-glow: rgba(255, 126, 41, 0.15);
    }
</style>
    ...
    <div class="detail-header-wrapper">
        <div class="detail-header-left">
            <div class="detail-header-badges">
                <span class="tag-badge-accent" style="display: inline-flex; align-items: center; gap: 6px; font-size: 0.85rem; color: #ff7e29; background: rgba(255, 126, 41, 0.1); border: 1px solid rgba(255, 126, 41, 0.3); backdrop-filter: blur(8px); font-weight: 700; border-radius: 30px; padding: 6px 14px;">
                    🍜 Ẩm Thực & Món Ngon Đông Anh
                </span>
                <span class="tag-badge-accent" style="display: inline-flex; align-items: center; gap: 6px; font-size: 0.85rem; color: #16a34a; background: rgba(22, 163, 74, 0.1); border: 1px solid rgba(22, 163, 74, 0.3); font-weight: 700; border-radius: 30px; padding: 6px 14px;">
                            ...
                            @foreach($items as $item)
                                ...
                                @else
                                    ...
                                    <div class="dish-card glass-panel" 
                                         ...
                                         @endif>
                                        <img src="{{ $item->image_path ?: asset('images/ocop-placeholder.png') }}" style="width: 80px; height: 80px; object-fit: cover; border-radius: 8px; flex-shrink: 0;" alt="{{ $item->name }}">

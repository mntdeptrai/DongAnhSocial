...
<head>
    <meta charset="UTF-8">
    <title>Mã xác thực OTP đăng ký</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="instruction">
                Bạn đang thực hiện đăng ký tài khoản mới trên hệ thống **Bản đồ khám phá đông anh**. 
                Vui lòng sử dụng mã OTP dưới đây để xác nhận đăng ký tài khoản của mình:
            </div>
            ...
            <div class="warning">
                Nếu bạn không thực hiện đăng ký này, vui lòng bỏ qua email hoặc liên hệ với ban quản trị để bảo mật tài khoản.
            </div>
        </div>
        <div class="footer">

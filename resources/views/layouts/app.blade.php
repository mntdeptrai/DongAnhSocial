                ...
                <div x-show="!chat.is_minimized" class="fchat-window" style="height: 520px;">
                    ...
                    <div class="fchat-header" @click="chat.is_minimized = !chat.is_minimized">
                        ...
                        <div style="display: flex; align-items: center; gap: 3px; flex-shrink: 0;" @click.stop>
                            ...
                            <button class="fchat-header-btn" title="Gọi thoại" @click="DongAnhWebRTC.startCall(chat.id, chat.name, chat.avatar_url || chat.avatar, 'audio')">
                            ...
                            <button class="fchat-header-btn" title="Gọi video" @click="DongAnhWebRTC.startCall(chat.id, chat.name, chat.avatar_url || chat.avatar, 'video')">

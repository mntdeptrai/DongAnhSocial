...
<style>
    :root {
        ...
        --category-accent-dark: #1d4ed8;
        --category-glow: rgba(37, 99, 235, 0.15);
    }
</style>
...
<div class="container" style="padding-top: 20px; margin-bottom: 24px;">
    ...
    <div class="detail-header-wrapper">
        ...
        <div class="detail-header-actions">
            ...
            <button id="btnSaveLocStay" onclick="toggleSaveLocation(this, '{{ $eatery->slug }}', '{{ addslashes($eatery->name) }}')" class="btn-secondary" style="border-radius: 30px; padding: 8px 18px; font-size: 0.9rem; border-color: var(--border-glow); display: flex; align-items: center; gap: 6px; background: var(--bg-card); color: var(--text-main); font-weight: 600; cursor: pointer; transition: all 0.2s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='none'">
                <span class="save-icon" style="font-size: 1.1rem;">❤️</span> <span class="save-text">Lưu lại</span>
            </button>
        </div>
        <script>document.addEventListener('DOMContentLoaded', () => initSaveButtonState(document.getElementById('btnSaveLocStay'), '{{ $eatery->slug }}'));</script>
    </div>
</div>
...
<div class="container">
    <div class="detail-grid">
        ...
        <div>
            ...
            @php
                $items = $eatery->rooms;
                $title = 'Loại phòng & Bảng giá lưu trú';
                $icon = '🛌';
                $emptyText = 'Chưa cập nhật loại phòng cho cơ sở lưu trú này.';
                $btnText = 'Xem tất cả loại phòng';
                $modalTitle = 'Danh sách loại phòng & Giá phòng - ' . $eatery->name;
                $itemUnit = 'phòng';
                $placeholderSearch = 'Tìm loại phòng, giường, tiện nghi...';
            @endphp
